...
export class OwnerItemCategoryService {
    /**
     * [점주] 상품 카테고리 목록 조회
     ...
     * @throws ApiError
     */
    public static getItemCategories1(
        storeId: number,
    ): CancelablePromise<CommonResponseListItemCategoryResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/owner/stores/{storeId}/item-categories',
            path: {
                'storeId': storeId,
            },
        });
     ...
     * @throws ApiError
     */
    public static createItemCategory1(
        storeId: number,
     ...
     * @throws ApiError
     */
    public static deleteItemCategory1(
        storeId: number,
        categoryId: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/owner/stores/{storeId}/item-categories/{categoryId}',
            path: {
                'storeId': storeId,
     ...
     * @throws ApiError
     */
    public static updateItemCategory1(
        storeId: number,
        categoryId: number,
        requestBody: Record<string, string>,

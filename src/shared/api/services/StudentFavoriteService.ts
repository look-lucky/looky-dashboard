...
import type { CommonResponsePageResponseStudentFavoriteStoreResponse } from '../models/CommonResponsePageResponseStudentFavoriteStoreResponse';
import type { CommonResponseVoid } from '../models/CommonResponseVoid';
import type { Pageable } from '../models/Pageable';
import type { CancelablePromise } from '../core/CancelablePromise';
import { OpenAPI } from '../core/OpenAPI';
import { request as __request } from '../core/request';
export class StudentFavoriteService {
    /**
     * [학생] 상점 즐겨찾기 추가
    ...
    public static addFavorite(
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/student/stores/{storeId}/favorites',
            path: {
                'storeId': storeId,
            },
            errors: {
    ...
    public static countFavorites(
        ...
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/student/stores/{storeId}/favorites/count',
            path: {
                'storeId': storeId,
            },
            errors: {
     ...
     * @returns CommonResponsePageResponseStudentFavoriteStoreResponse 조회 성공
     * @throws ApiError
     */
    public static getMyFavorites(
        pageable: Pageable,
    ): CancelablePromise<CommonResponsePageResponseStudentFavoriteStoreResponse> {
        return __request(OpenAPI, {
            method: 'GET',

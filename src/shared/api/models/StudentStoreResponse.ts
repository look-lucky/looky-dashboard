...
export type StudentStoreResponse = {
    id?: number;
    userId?: number;
    name?: string;
    branch?: string;
    ...
    isSuspended?: boolean;
    storeStatus?: StudentStoreResponse.storeStatus;
    myPartnerships?: Array<PartnershipInfo>;
    cloverGrade?: StudentStoreResponse.cloverGrade;
    profileImageUrl?: string;
};
export namespace StudentStoreResponse {
